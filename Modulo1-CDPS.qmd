...
- Dados administrativos usuais se tornaram dados secundários de pesquisa 
  - Ex: Registros eletrônicos do **e-SUS**, **SIH/SUS**, **SINAN** e **SIVEP**

- Dados não usuais tornaram-se mais acessíveis
  - Ex, análise de dados não estruturados, como áudios consultas, imagens de exames, etc.  

- Novas possibilidades de coleta de dados
  - Ex: Análise em tempo real de dados oriundos de dispositivos vestíveis (wearables) e apps de saúde
...
## Maior empregabilidade e protagonismo do estudante
...
## Novo mundo: a pesquisa com seu co-piloto
