...
- Dados administrativos se tornaram dados secundários de pesquisa (Coeli, 2024)
    - Por exemplo: **e-SUS**, **SIH/SUS**, **SINAN** e **SIVEP**
- Registros eletrônicos, exames e sensores tornam os dados mais complexos e diversos
    - Dados estruturados e não estruturados
- "Ciência de Dados Populacionais" (*Populational Data Science*) (McGrail et al, 2018)
- Novas possibilidade de coleta de dados
...
- Novas possibilidades de análise
  ...
  - Análise de dados não estruturados
    - p.e, textos, imagens, vídeos
- Ampliação da 'caixa de ferramentas' do pesquisador
  - Predição
  - Classificação 
  - Agrupamento
...
- Pesquisas com maior aplicação prática (link com extensão)
  - Análise de dados em tempo real
  - Criação de produtos tecnológicos (produtos de dados) 
- Fortalecimento dos pilares da universidade
    

## Aprimoramento da Prática Científica {.smaller}

- Uso de uma linguagem de programação:
  - Aumenta a **reprodutibilidade** e **transparência**
  - Melhora a **comunicação dos resultados**
  - Melhora o diálogo entre grupos de pesquisa
  - Melhora o fluxo de orientação/mentoria
  - Fortalece a **ciência aberta** e a **confiança pública**
  - Permite interação mais natural com ferramentas de IA
  - Interdisciplinariedade (áreas aplicadas com Sistemas de Informação, Computação...)
