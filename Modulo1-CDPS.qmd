...
-   No R, **objetos** são entidades que armazenam dados
...
-   Geralmente um vetor contém apenas objetos atômicos da mesma classe
    - Exceção: *lista*: um tipo especial de vetor
:::
...
-   A odem dos níveis pode ser estabelecida com o argumento *levels* da função *factor()*.
    -   Tb relevante para modelagem, pois o primeiro nível é utilizado como *baseline*
...
Existem muitas operações que podem ser utilizadas para extrair subconjuntos dos objetos do R
...
-   Permitem controlarmos o fluxo de execução de um programa (script)
...
-   break: para a execução de um *loop*
...
-   next: pula uma interação de um *loop*
