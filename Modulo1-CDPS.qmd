...
dt_notific <- read.dbf(file = 'Módulo_3/Dados/NINDINET.dbf') |>
  # Selecionando as variáveis que queremos utilizar com a função `select()`
...
# Obterndo o resultado como inteiro
...
# calcularemos a diferença em dias entre a data de nascimento e a data de 
# primeiros sintomas para saber a idade (dias) que nossos pacientes tinham 
...
# 9.3 Extração de dia, mês, ano e dia da semana
...
# 9.4 Identificando a semana epidemiológica nas datas
...
write_csv(x = base_menor,
          file = "C:/Users/UFR/Documents/Curso_Vigilancia_Saude/Módulo_3/Dados/base_menor_curso.csv")

install.packages("writexl");library(writexl)
# Salvando a tabela {base_menor} em seu computador na pasta "Meus documentos"
write_xlsx(x = base_menor,
           path = "C:/Users/UFR/Documents/Curso_Vigilancia_Saude/Módulo_3/Dados/base_menor_curso.xlsx")
